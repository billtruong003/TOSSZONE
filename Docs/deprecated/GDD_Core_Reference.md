> 🗄️ **DEPRECATED 2026-07-13 — PIVOT sang VR multiplayer FPS.** Concept toss-party / vòng-buff / weapon-panel trong file này KHÔNG còn là thiết kế trung tâm. Nguồn chân lý mới: `Docs/GameDesign/VR-FPS-Playable-GDD-v0.1.md`. Giữ lại chỉ để tham chiếu feel-tuning; bài học network/avatar vẫn còn hiệu lực ở `Docs/Network_Architecture_Lessons.md` + `Docs/Fusion_Shared_Mode_Gotchas.md` (hai file đó KHÔNG deprecated).
