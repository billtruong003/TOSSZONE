> 🗄️ **DEPRECATED 2026-07-13 — PIVOT sang VR multiplayer FPS.** Hệ đạn mass (ring-multiply ×12 stack) không cần cho FPS hitscan. Nguồn chân lý mới: `Docs/GameDesign/VR-FPS-Playable-GDD-v0.1.md`. Giữ lại làm reference nếu sau này cần bullet-hell/instancing.
