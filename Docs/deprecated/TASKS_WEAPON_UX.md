> 🗄️ **DEPRECATED 2026-07-13 — PIVOT sang VR multiplayer FPS.** Weapon panel / 6-weapon shop / ring UX thuộc toss game cũ, superseded bởi gunplay hitscan. Nguồn chân lý mới: `Docs/GameDesign/VR-FPS-Playable-GDD-v0.1.md`.
