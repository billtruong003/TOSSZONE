> 🗄️ **DEPRECATED 2026-07-13 — PIVOT sang VR multiplayer FPS.** Physics-throw không còn là mechanic trung tâm (CUT theo GDD pivot). Nguồn chân lý mới: `Docs/GameDesign/VR-FPS-Playable-GDD-v0.1.md`. Giữ lại làm reference feel-tuning + bài học peak-velocity/Bill.Events.
