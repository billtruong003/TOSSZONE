...
- **S11** sửa hạ tầng: gỡ embed kit GUID-lệch (root cause pink material sau pull), .gitattributes + autocrlf + SmartMerge, dọn orphan meta (DevAgent/Photon/Beautify), ImportWorkerGhostWindowFix (cửa sổ trắng tích tụ = AssetImportWorker leak, không phải BillGameCore).
