...
{
    /// <summary>
    /// Custom procedural poser for the humanoid avatar (whatever rigged model is wired) driven by the three synced tracking
    ...
    public class AvatarArmPoser : MonoBehaviour
    {
